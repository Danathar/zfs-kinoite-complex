...
- Issues: state the problem as a user would see it, then the evidence, then the proposed fix. The title says what is wrong, not what kind of finding it is; keep any prefix the tooling requires.
