...
The repository's own GPL-3.0 licensing is a separate issue. It does not
...
consumed by the build, and it neither resolves nor changes the CDDL/GPLv2
kernel-module redistribution question described above.
